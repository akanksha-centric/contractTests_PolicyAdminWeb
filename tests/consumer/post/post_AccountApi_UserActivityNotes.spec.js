...
const accountUserActivityRequestBody = require("../../data/body/accountUserActivityNotesBody.json");
...
describe("Account User Activity Notes consumer test", () => {
    ...
    describe("When a call is made to API for user activity notes and user is not authorized", () => {
        before(() => mockprovider.addInteraction({
        ...
        it("It will return a 401 unauthorized response", () => {
            return expect(createApiCall("/v1/accounts/9404268316/contactDetails/user_activities/notes")).to.eventually.be.rejectedWith("Unauthorized")
        })
    })
